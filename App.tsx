...
import { ApplicationStartScreen } from './src/modules/applications/presentation/ApplicationStartScreen';
...
export default function App() { useEffect(() => { configureApplicationStore(repository); }, []); return <NavigationContainer theme={{ ...DefaultTheme, colors: { ...DefaultTheme.colors, background: '#F3F6FB' } }}><Stack.Navigator initialRouteName="Login" screenOptions={{ headerShown: false }}><Stack.Screen name="Login" component={LoginScreen} /><Stack.Screen name="Home" component={HomeScreen} /><Stack.Screen name="ApplicationStart" component={ApplicationStartScreen} /><Stack.Screen name="ApplicationIntro" component={ApplicationIntroScreen} /><Stack.Screen name="Documents" component={DocumentsScreen} /><Stack.Screen name="Wizard" component={ApplicationWizardScreen} /><Stack.Screen name="Signature" component={SignatureScreen} /><Stack.Screen name="Success" component={ApplicationSuccessScreen} /><Stack.Screen name="ApplicationsList" component={ApplicationsListScreen} /><Stack.Screen name="Placeholder" component={PlaceholderScreen} /></Stack.Navigator></NavigationContainer>; }
